...
{
    class CajaTopicConsumer
    {
		public static CajaTopicConsumer Instancia = null;
        static hospitalEntities hospital = new hospitalEntities();
        public static CajaTopicConsumer GetInstance()
		{
			if (Instancia == null)
			{
				Instancia = new CajaTopicConsumer();
			}
        ...
        public CajaTopicConsumer()
        {
            subscriptionClient = new SubscriptionClient(serviceBusConnection, "cajatopic", "CajaTopic-Core");
        }
